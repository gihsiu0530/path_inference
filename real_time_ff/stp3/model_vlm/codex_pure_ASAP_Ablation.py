...
class VLM_STP3_Gen(nn.Module):
    ...
    def forward(self, image, intrinsics, extrinsics, future_egomotion, *,
        ...
        # Depth-input ablation: preserve the depth branch and tensor contract,
        # but remove all per-pixel depth information.
        self._last_depth_seq = torch.zeros_like(depth_224_seq, device=device)
